...
export default function Navbar() {
  ...
  return (
    <nav
      className={cn(
        "fixed top-0 left-0 right-0 z-50 bg-navy transition-all duration-300",
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between text-white items-center w-full mt-2">
          <div className="text-2xl font-bold ">KRAFTX</div>
